const {detectFrame, findPotentialLines, findBorder, getAir, generateLine, generatePortal, makeWorldWithPortal} = require("../").portal_detector("1.8");
    ...
    describe("Detect " + name, () => {
      ...
      describe("detect potential first lines", () => {
        it("detect potential first lines from bottom left", async () => {
          ...
          expect(potentialLines).toContain({
            "direction": direction,
            "line": bottom
          });
        });
