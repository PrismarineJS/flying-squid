...
import portal_detector from "../portal_detector"
...
export const server = function (serv, { version }) {
  const { generatePortal, addPortalToWorld, detectFrame } = portal_detector(version)
  const mcData = require('minecraft-data')(version)
