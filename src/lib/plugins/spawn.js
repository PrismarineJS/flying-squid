...
module.exports.server = function (serv, options) {
  ...
  serv.spawnObject = (type, world, position, {
    pitch = 0, yaw = 0, velocity = new Vec3(0, 0, 0), data = 1, itemId, itemDamage = 0, pickupTime = undefined, deathTime = undefined,
  }) => {
  ...
  serv.spawnMob = (type, world, position, {
    pitch = 0, yaw = 0, headPitch = 0, velocity = new Vec3(0, 0, 0), metadata = [],
  } = {}) => {
